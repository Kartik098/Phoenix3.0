...
class Signup extends Component{
  ...
  return (
    ...
    <div className="signup">
      <h1>Signup</h1>
      <Form className='form'>
      <input type="text" name='fullname' placeholder='Full Name' value={this.state.credentials.fullname   } onChange={this.inputChanged} className='sinput'/><br />
    ...
    <div className='center'> <h3>Already have an account? <a href='/login'>Login</a></h3></div>
    </>
  )
}
};
